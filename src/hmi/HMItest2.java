...
*/
public class HMItest2 extends ApplicationFrame implements ActionListener {
    ...
    private double lastValue = temp.getTemperature();
     ...
     */
    public HMItest2(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final HMItest2 demo = new HMItest2("Dynamic Line And TimeSeries Chart");
        demo.pack();
